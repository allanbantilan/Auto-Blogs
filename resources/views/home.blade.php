    ...
    <body class="font-light antialiased">
        ...
        <div class="w-full text-center py-32">
            <h1 class="text-2xl md:text-3xl font-bold text-center lg:text-5xl text-gray-700">
                Welcome to <span class="text-yellow-500">Auto Blogs</span> <span class="text-gray-900"></span>
            </h1>
            <p class="text-gray-500 text-lg mt-1">Everything you need to know about cars!</p>
